...
## 1. implement the payement gateway
    ...
    - for user who use visa payements, they are offered a 21 days free trial
    - implement a feature to block abuse of free trials
    - users who are going to pay via mobile money can not have free trials(because its easier to implement an automatic subscription with visa payements than mobile money payments)
    - users should be allowed to cancle subscriptions.
    - make sure that users only access what they pay for
